...
async def main():
    ...
    dataset = "redial"
    local_model_path_name = "test_epoch1_seed2_collab_lr1e-6"
    alg = "DPO"
    model = "llama3-2-1b-instruct"
    # File paths
    csv_input_path = "../datasets/"+dataset+"/multiturn_form/test.csv"
    user_prompt_template_path = "../prompts/test_user_prompt.txt"
    csv_output_path = f"multiturn_test/{alg}/{model}/{dataset}/generated_movie_conversations_collab_lr1e-6_2.csv"
