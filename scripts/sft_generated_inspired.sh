...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 WANDB__SERVICE_WAIT=300 torchrun --master_port=56800 --nnodes=1 --nproc_per_node=8 -m finetuning.sft \
    --dataset_repo datasets/inspired/sft_generated/llama3-2-1b-instruct/train_sft_generated2.csv \
    --output_dir outputs/sft_generated_thd1/inspired/llama3-2-1b-instruct/test_epoch5_seed2_hit \
    --seed 2 \
