...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 WANDB__SERVICE_WAIT=300 torchrun --master_port=56800 --nnodes=1 --nproc_per_node=8 -m finetuning.dpo \
    --dataset_repo datasets/inspired/DPO_entropy/llama3-2-1b-instruct/DPO_turn_entropy_reduced_margin0.5.csv \
    --output_dir outputs/DPO/inspired/llama3-2-1b-instruct/test_epoch10_seed2_turn_entropy_margin0.5_lr5e-6 \
    --seed 2 \
    --model_name outputs/sft_generated/inspired/llama3-2-1b-instruct/test_epoch5_seed2_conv_entropy_lr2e-5 \
