...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 WANDB__SERVICE_WAIT=300 torchrun --master_port=56800 --nnodes=1 --nproc_per_node=8 -m finetuning.dpo \
    --dataset_repo datasets/redial/DPO_entropy/llama3-2-1b-instruct/DPO_turn_entropy_reduced.csv \
    --output_dir outputs/DPO/redial/llama3-2-1b-instruct/test_epoch1_seed2_turn_entropy_lr1e-6 \
    --seed 2 \
