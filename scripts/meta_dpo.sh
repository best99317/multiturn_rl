...
# ./scripts/dpo_offline_redial.sh # Execute the first script
...
./scripts/dpo_offline_redial_copy.sh # Execute the second script
echo "Script 2 finished."

echo "Pausing for 1 minute..."
sleep 1m # Pause for 1 minute

echo "Starting Script 3..."ß
./scripts/dpo_offline_redial_copy_2.sh # Execute the third script
...
./scripts/dpo_offline_redial_copy_3.sh # Execute the fourth script
