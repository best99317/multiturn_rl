...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 WANDB__SERVICE_WAIT=300 torchrun --master_port=56800 --nnodes=1 --nproc_per_node=8 -m finetuning.sft \
    --dataset_repo datasets/redial/sft_generated/llama3-2-1b-instruct/conv_entropy_top8631.csv \
    --output_dir outputs/sft_generated/redial/llama3-2-1b-instruct/test_epoch5_seed2_conv_entropy_lr1e-4 \
    --seed 2 \
